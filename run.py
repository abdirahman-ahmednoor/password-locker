...
#main function
def main():
    print("Hello. Welcome to Kifuli. Please login and add new account to continue .\n\n")
            ...
            if user_logged_in:
                ...
                while True:
                    ...
                    #existing credential
                        ...
                        account = display_accounts(user_logged_in.username)
                        if accounts:
                            print('\n\n***Delete Credential***\n\n')
